    ...
    <h2>
        ...
        <form method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <select id="domisili" name="domisili" class="custom-select text-uppercase" required="required">
        ...
        <table class="table table-dark ">
            ...
            <tr>
                ...
                <td><?= $email; ?></td>
                <td><?= $gender; ?></td>
                <td class="text-uppercase"><?= $domisili; ?></td>
                <td><?= $prodi; ?></td>
